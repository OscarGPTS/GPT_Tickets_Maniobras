    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-2 flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    @if($ticket->status === 'pendiente')
                        ...
                        <button onclick="document.getElementById('cancelSection').classList.toggle('hidden')"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <!-- Formulario de cancelación (oculto por defecto) -->
                @if($ticket->status === 'pendiente')
                    <div id="cancelSection" class="bg-red-50 border-l-4 border-red-400 rounded-lg p-6 hidden">
                        ...
                        <form method="POST" action="{{ route('solicitante.tickets.cancel', $ticket) }}" class="mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="cancellation_reason" id="cancellation_reason" rows="3" 
                                         ...
                                         placeholder="Explica brevemente por qué cancelas este ticket (opcional)..."></textarea>
                                <p class="mt-1 text-xs text-gray-500">
                                    Puedes dejar este campo vacío si no deseas proporcionar una razón.
                                </p>
                            </div>
                            <div class="flex items-center justify-end space-x-3">
                                <button type="button" 
                                        onclick="document.getElementById('cancelSection').classList.add('hidden')"
                ...
                @if($ticket->status === 'finalizado' && $ticket->survey && !$ticket->survey->completed_at)
                    <div id="survey-form" class="bg-white shadow rounded-lg p-6">
                        ...
                        <form method="POST" action="{{ route('solicitante.surveys.complete', $ticket->survey) }}" class="space-y-4">
                            @csrf
                            <div>
