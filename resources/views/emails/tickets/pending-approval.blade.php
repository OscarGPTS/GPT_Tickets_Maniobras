...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Solicitud Pendiente de Aprobación</h1>
            <p class="subtitle">Sistema de Movimiento de Carga</p>
        </div>
        
        <div class="content">
            <p class="greeting">Estimado(a) <strong>Administrador</strong>,</p>
            
            <p>Se ha generado una nueva solicitud que requiere tu aprobación.</p>
