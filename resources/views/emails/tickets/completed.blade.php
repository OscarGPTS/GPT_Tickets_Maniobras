...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>¡Ticket Completado!</h1>            <p class="subtitle">Sistema de Movimiento de Carga</p>        </div>
        
        <div class="content">
            <p class="greeting">Estimado(a) <strong>{{ $recipient->name }}</strong>,</p>
            
            <p>¡Excelentes noticias! Tu solicitud de movimiento de carga ha sido completada exitosamente.</p>
            ...
            <p style="color: #666666; font-size: 14px;">
                Gracias por utilizar nuestro sistema de solicitudes.
            </p>
        </div>
