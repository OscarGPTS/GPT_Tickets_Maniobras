...
<head>
    ...
    <title>Nueva Solicitud de Movimiento</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1>Nueva Solicitud de Movimiento</h1>
        </div>
        
        <div class="content">
            <p class="greeting">Estimado(a) <strong>{{ $recipient->name }}</strong>,</p>
            
            <p>Se ha creado una nueva solicitud de movimiento de carga que requiere su atención.</p>
            ...
            <p style="color: #666666; font-size: 14px;">
                Por favor revise y asigne esta solicitud a la brevedad posible a través del sistema.
            </p>
        </div>
